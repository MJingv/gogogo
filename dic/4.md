...
- what the opening time for those two
...
- the cathedral is self open morning end the afternoon
- the castle is just open from 1 to 5,so we can't go there until after lunch
- i really want to spend sometime in the art gallery ,because i got this wonderful painting by rb , i want to see
- what else should we see
- the guidebook says the partinical garden values spending some time in,they're open all from 8 to 6,so we go there
  anytime
...
- maybe we should go to the cathedral today,because it's sunday tomorrow when even through it's open everyday ,it might
...
- the castle is open everyday except monday, so *we're ok*  there ,and the garden is of course only closed at night
- are all the places free or do we have to pay to go in
- what's the guidebook saying
- i think that's charged for all of them except the parnatic gardens
- and the markets,of course you don't pay to go in
- ok,painint ,the lunch casle after that, then the cathedral
- ok let's  look at us plan like this,we'll go to see the painting you liked first, the rb,then have lunch, and go on the castle after that,then the cathedral
- ok,it's here ,the roof of the cathedral look really beautiful
- is that right
- what i really want to do in cathedral is climing the towel
- the view is supposed to be specticular
- ok,that'll  be more than today
- and tomorrow let's go to the p garden and have a picnic
- i want to see the b river and watch the swaanze
